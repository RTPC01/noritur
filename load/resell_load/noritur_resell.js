...
module.exports.index = async (req, res) => {
    ...
    res.render('noritur_resell/index', { boards });
}
...
module.exports.createRabbit = async (req, res, next) => {
    ...
    res.redirect(`/noritur_resell/${board._id}`)
}
...
module.exports.showRabbit = async (req, res,) => {
    ...
    if (!board) {
        ...
        return res.redirect('/noritur_resell');
    } 
    res.render('noritur_resell/show', { board });
}
...
module.exports.renderEditForm = async (req, res) => {
    ...
    res.render('noritur_resell/edit', { board });
}
